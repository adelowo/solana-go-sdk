import{_ as n,e as s}from"./app.1c7e74c3.js";const a={},t=s(`<h1 id="sign-metadata" tabindex="-1"><a class="header-anchor" href="#sign-metadata" aria-hidden="true">#</a> Sign Metadata</h1><p>to convert a unverified creator to a verifeid creator.</p><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
