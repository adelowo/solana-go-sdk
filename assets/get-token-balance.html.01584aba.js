import{_ as n,e as s}from"./app.1c7e74c3.js";const a={},t=s(`<h1 id="get-token-balance" tabindex="-1"><a class="header-anchor" href="#get-token-balance" aria-hidden="true">#</a> Get Token Balance</h1><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
